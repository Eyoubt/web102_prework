...
const displayStr = `
  ...
  GAMES_JSON.length
    ...
    Currently, ${listOfUnfunded.length} 
    ${listOfUnfunded.length <= 1 ? "game remains" : "games remain"}
    unfunded. We need your help to fund these amazing games!
`;

// create a new DOM element containing the template string and append it to the description container
descriptionContainer.append(
  (document.createElement("p").innerHTML = displayStr)
);
...
const [topFundedGame, secondTopFundedGame, ...restOfGames] = sortedGames;
...
const secondTopFundedGameElement = document.createElement("p");
secondTopFundedGameElement.textContent = `${secondTopFundedGame.name}`;
secondGameContainer.appendChild(secondTopFundedGameElement);
